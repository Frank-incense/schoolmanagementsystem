  ...
  const navigationData = {
    ...
    sections: [
      ...
      },
      {
        ...
        type: "category",
        children: [
          { title: "All Students", route: "/students", badge: "1,256" },
          { title: "Active Students", route: "/students/active", badge: "1,234", status: "🟢" },
          { title: "Inactive Students", route: "/students/inactive", badge: "22", status: "🔴" },
          { title: "Add New Student", route: "/students/add", icon: <Plus size={16} /> }
        ]
      },
      {
        id: "fees",
